...
# GrEA Function
def grid_based_evolutionary_algorithm(population_size = 5, divisions = 10, mutation_rate = 0.1, min_values = [-5,-5], max_values = [5,5], list_of_functions = [func_1, func_2], generations = 50, mu = 1, eta = 1, k = 4):       
    count      = 0
    M          = len(list_of_functions)
